...
class BaseController{
	...
	function __construct(){
		...
		$this->file_upload_settings['AKTA_CERAI'] = array(
			"title" => "{{random}}",
			"extensions" => ".pdf",
			"limit" => "1",
			"filesize" => "2",
			"returnfullpath" => true,
			"filenameprefix" => "AKTA_CERAI",
			"uploadDir" => "uploads/photos/"
		);
		$this->file_upload_settings['E_DOCS'] = array(
			"title" => "{{random}}",
			"extensions" => ".pdf",
			"limit" => "1",
			"filesize" => "5",
			"returnfullpath" => true,
			"filenameprefix" => "E_DOCS",
			"uploadDir" => "uploads/photos/"
		);
	

		$this->file_upload_settings['FOTO_AC'] = array(
			"title" => "{{random}}",
			"extensions" => ".jpg,.png,.gif,.jpeg",
			"limit" => "1",
			"filesize" => "1",
